	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'service-gradient': 'linear-gradient(145deg, #f093fb 0%, #f5576c 100%)',
				'card-gradient': 'linear-gradient(145deg, #667eea 0%, #764ba2 50%, #f093fb 100%)',
